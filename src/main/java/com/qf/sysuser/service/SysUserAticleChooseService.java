...
public interface SysUserAticleChooseService {

    //添加筛选新闻到area_type_img表中
    boolean addToImg(ArticleInfo articleInfo);

    //已加入area_type_img表中的新闻将设置状态为2
    boolean updateState(int articleId);
    ...
    //根据这个id删除掉这条新闻信息
    boolean removeArticleUseId(int articleId);
